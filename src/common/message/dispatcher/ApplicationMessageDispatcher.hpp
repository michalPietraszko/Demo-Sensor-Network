...
protected:
    virtual void onComponentModifyReceived(SmartSharedMessage& msg) { LOG_ERR("Unhandled ComponentModify!"); }

    virtual void onSensorReportReq(SmartSharedMessage& msg) { LOG_ERR("Unhandled SensorReportReq!"); }
};