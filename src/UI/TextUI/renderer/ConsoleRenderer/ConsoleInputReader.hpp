...
class ConsoleInputReader {
    ...
    constexpr static auto asciiEnterKeyApple = 10u;
    constexpr static auto asciiBackspaceKeyApple = 127u;
    constexpr static auto asciiEnterKey = 13u;
    constexpr static auto asciiBackspaceKey = 8u;
...
private:
    ...
    void printCurrentInput() { std::cout << "\33[2K\r" << tempBuffer << std::flush; }
