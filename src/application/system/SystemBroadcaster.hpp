...
{
public:
    SystemBroadcaster(SystemComponents& components)
        : m_Components{components}
    {}

    void broadcastStart()
    {
        boradcast<ComponentModify>(ComponentModify::Cause::componentEnable);
    }

    void boradcastStop()
    {
        boradcast<ComponentModify>(ComponentModify::Cause::componentDelete);
    }
